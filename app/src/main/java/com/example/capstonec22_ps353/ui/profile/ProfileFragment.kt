        ...
        lifecycleScope.launch {
            sharedViewModel.navController.observe(viewLifecycleOwner) {
                ...
                prefViewModel.getInfo().observe(viewLifecycleOwner) { user ->
                    ...
                    binding.apply {
                        layPengaturan.setOnClickListener {
                            navController.navigate(R.id.action_mainFragment_to_onDevelopFragment)
                        }
                        layPrivasi.setOnClickListener {
                            navController.navigate(R.id.action_mainFragment_to_onDevelopFragment)
                        }
                    ...
                    if (!user.isLogin) {
                        ...
                        Toast.makeText(activity, "Anda Telah Keluar Akun", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
            }
